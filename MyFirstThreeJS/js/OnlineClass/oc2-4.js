...
function createBody() {
   ...
   var sphereGeometry = new THREE.SphereGeometry( 58, 32, 16 );
   ...
   var cylinderGeometry = new THREE.CylinderGeometry(12,12,390,32);
...
function createHead() {
   ...
   var sphereGeometry = new THREE.SphereGeometry( 52, 32, 16 );
   var sphere = new THREE.Mesh( sphereGeometry, sphereMaterial );
   sphere.position.x = 0 ;	
   ...
   var cylinderGeometry = new THREE.CylinderGeometry(71, 71, 10, 32);
   var cylinder = new THREE.Mesh( cylinderGeometry, cylinderMaterial );
   cylinder.position.x = 0 ;	
   cylinder.position.y = 160 + 390 + 40;	
   cylinder.position.z = 0;	
   scene.add( cylinder );  

   var cylinderGeometry = new THREE.CylinderGeometry(40, 40, 140, 32);
   var cylinder = new THREE.Mesh( cylinderGeometry, cylinderMaterial );
   cylinder.position.x = 0 ;	
   cylinder.position.y = 160 + 390 + 40 + 10;	
   cylinder.position.z = 0;	
   scene.add( cylinder );  
